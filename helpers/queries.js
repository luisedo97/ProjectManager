...
let queries = {
    general: {
        ...
        getListProject: new PS('get-project', "SELECT * FROM PROJECTS WHERE users_id = $1 ORDER BY project_id"),
        ...
        getListItem: new PS('get-item', "SELECT it.*,pj.project_name,pj.users_id FROM PROJECT_ITEM it RIGHT JOIN PROJECTS pj ON it.project_id=pj.project_id WHERE pj.project_id = $1 ORDER BY project_item_id"),
        ...
        regulateAccess: new PS('regulate-access', "SELECT pj.* FROM PROJECT_ITEM it INNER JOIN PROJECTS pj ON it.project_id=pj.project_id INNER JOIN USERS us ON pj.users_id=us.users_id WHERE pj.project_id= $1 AND us.users_id= $2"),
        ...
        getProjectName: new PS('get-prj-name', "SELECT project_name FROM PROJECTS WHERE project_id= $1")
    },
    user: {
        actions: {
            projects: {
